  ...
  'inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors duration-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        registerButton: "relative backdrop-blur-md inline-flex !px-5 !h-12 items-center justify-center overflow-hidden text-sm font-medium text-sky-600  rounded-lg group bg-gradient-to-br from-gray-100 to-blue-200 group-hover:from-gray-200 group-hover:to-sky-400   dark:from-blue-600 dark:to-sky-400 dark:group-hover:from-gray-200 dark:group-hover:to-blue-300 dark:text-white dark:group-hover:text-sky-600 focus:ring-4 focus:outline-none focus:ring-red-800/10 dark:focus:ring-sky-800/10",
        loginButton: "relative backdrop-blur-md inline-flex !h-12 items-center justify-center !p-0.5 overflow-hidden text-sm font-medium text-sky-600 rounded-lg group bg-gradient-to-br from-gray-100 to-blue-200 group-hover:from-gray-200 group-hover:to-sky-400  dark:from-blue-600 dark:to-sky-400 dark:group-hover:from-gray-200 dark:group-hover:to-blue-300 dark:text-white focus:ring-4 dark:group-hover:text-sky-600 focus:outline-none focus:ring-red-800/10 dark:focus:ring-sky-800/10",
